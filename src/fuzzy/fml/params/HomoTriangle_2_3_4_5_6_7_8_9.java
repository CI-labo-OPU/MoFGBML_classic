...
public class HomoTriangle_2_3_4_5_6_7_8_9 {
	static float[][] params = new float[][]
	{
		...
		//9分割
		new float[] {0f, 0f, 1f/8f},
		new float[] {0f, 1f/8f, 2f/8f},
		new float[] {1f/8f, 2f/8f, 3f/8f},
		new float[] {2f/8f, 3f/8f, 4f/8f},
		new float[] {3f/8f, 4f/8f, 5f/8f},
		new float[] {4f/8f, 5f/8f, 6f/8f},
		new float[] {5f/8f, 6f/8f, 7f/8f},
		new float[] {6f/8f, 7f/8f, 1f},
		new float[] {7f/8f, 1f, 1f}
	};
